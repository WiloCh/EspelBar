...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h4 class="font-weight-bold"> Preferencias </h4>
                </div>
                @can('create', App\Preferencia::class)
    ...
    <table class="table table-bordered">
        ...
        <thead>
            <tr>
                ...
                <td class="font-weight-bold">Menu</td>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{route('preferencias.show',['preferencia'=>$preferencia] )}}" class="btn btn-info">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                            <path fill-rule="evenodd" d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                        </svg>
                    </a>
                    @can('edit', $preferencia)
                    <a href="{{route('preferencias.edit',['preferencia'=>$preferencia] )}}" class="btn btn-primary">
                ...
                <td class="align-middle">{{$preferencia->menu->bar->nombre}}</td>
                <td class="align-middle">{{$preferencia->menu->nombre}}</td>
                <td class="align-middle">{{$preferencia->fecha}}</td>
                <td class="align-middle">{{$preferencia->observacion}}</td>
