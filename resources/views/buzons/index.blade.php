...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                <h4 class="font-weight-bold"> Buzón de Opiniones </h4>
                </div>
                @can('create', App\Buzon::class)
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{route('buzons.show',['buzon'=>$buzon] )}}" class="btn btn-info">
                    ...
                    @can('edit', $buzon)
                    <a href="{{route('buzons.edit',['buzon'=>$buzon] )}}" class="btn btn-primary">
                ...
                <td class="align-middle">{{$buzon->bar->nombre}}</td>
