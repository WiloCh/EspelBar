...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h4 class="font-weight-bold"> Snacks </h4>
                </div>
                @can('create', App\Snack::class)
    ...
    <table class="table table-striped">
        ...
        <thead>
            <tr>
                ...
                <td class="font-weight-bold">Nombre del Snack</td>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{route('snacks.show',['snack'=>$snack] )}}" class="btn btn-info">
                    ...
                    @can('edit', $snack)
                    <a href="{{route('snacks.edit',['snack'=>$snack] )}}" class="btn btn-primary">
                ...
                <td class="align-middle">{{$snack->bar->campus->nombre}}</td>
                <td class="align-middle">{{$snack->bar->nombre}}</td>
